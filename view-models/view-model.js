/**
 * View Model bound in our jquery call at the bottom of index.html
 */
function ViewModel() {
...
/**
 * Helper function, calls on the files in /js folder to get the original
 * question array, and build an array of random questionsAnswers objects pulled
 * from that array.
 */
function populateQuestions(numQuestions) {
  const QuestionsArray = getAllQuestionsAndAnswers();
  return questionList(QuestionsArray, numQuestions);
}
